/*  
    ...
    in the prodiction build only*. A separate bundle for vendor
    code is useful since it's unlikely to change as often
    as the application's code. So all the libraries we reference
    here will be written to vendor.js so that can be 
    cached until on of them change. So basically, this avoids
    ...
    Any files that aren't referenced here wil be bundled into
